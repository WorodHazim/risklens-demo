...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] font-sans text-[#E5E5E0] pb-12 selection:bg-[#D4B483] selection:text-black">
      ...
      <nav className="bg-[#0A0A0A] px-6 py-4 border-b border-[#1F1F1F] sticky top-0 z-50">
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:flex items-center space-x-2 pl-6">
              <button className="px-4 py-2 text-[10px] uppercase tracking-wider font-bold text-[#D4B483] bg-[#141414] border border-[#333] rounded-sm">Dashboard</button>
              <button className="px-4 py-2 text-[10px] uppercase tracking-wider font-bold text-[#666] hover:text-[#CCC] transition-colors">Policies</button>
              <button className="px-4 py-2 text-[10px] uppercase tracking-wider font-bold text-[#666] hover:text-[#CCC] transition-colors">Audit Log</button>
            </div>
          </div>

          <div className="flex items-center gap-6">
            <button onClick={handleExportQueue} className="text-[10px] font-bold uppercase tracking-wider text-[#666] hover:text-[#D4B483] transition-colors flex items-center gap-2">
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-[#1F1F1F]">
              <div className="text-right hidden sm:block">
                <p className="text-[11px] font-bold text-[#CCC] uppercase tracking-wide">Alex Chen</p>
                <p className="text-[9px] text-[#666] uppercase tracking-wider">Sr. Risk Analyst</p>
              </div>
              <div className="h-8 w-8 rounded-sm bg-[#1A1A1A] border border-[#262626] flex items-center justify-center text-[10px] font-bold text-[#D4B483]">
                AC
              </div>
            </div>
          </div>
      ...
      <div className="max-w-[1440px] mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-8 mt-4">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-[#0A0A0A] rounded-sm border border-[#1F1F1F] p-5 relative overflow-hidden">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-[10px] font-bold text-[#888] uppercase tracking-wide">Active</span>
                </div>
              </div>
            ...
            <div className="space-y-3 pt-4 border-t border-[#141414]">
              <div className="relative group">
                <svg className="w-3.5 h-3.5 absolute left-3 top-3 text-[#555] group-focus-within:text-[#D4B483] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                <input
                  type="text"
              ...
              <div className="flex gap-2">
                <select
                  className="flex-1 text-[10px] font-bold uppercase border border-[#1F1F1F] rounded-sm px-2 py-2 bg-[#0F0F0F] text-[#888] focus:border-[#D4B483] focus:ring-0 focus:outline-none"
                  value={riskFilter}
          ...
          <div className="bg-[#0A0A0A] rounded-sm border border-[#1F1F1F] overflow-hidden flex flex-col h-[600px]">
            <div className="px-6 py-4 border-b border-[#1F1F1F] flex justify-between items-center bg-[#0F0F0F]">
              <div>
                <h2 className="text-[10px] font-bold text-[#E5E5E0] uppercase tracking-widest">Priority Queue</h2>
                <p className="text-[9px] text-[#555] mt-0.5 uppercase tracking-wide">Sorted by Impact & SLA Urgency</p>
              </div>
              <button onClick={() => window.location.reload()} className="text-[9px] font-bold text-[#D4B483] hover:text-[#E5D4A3] uppercase tracking-wider flex items-center gap-1">
                Sync Queue
              </button>
            </div>
            <div className="overflow-y-auto flex-1 p-2 space-y-2 scrollbar-thin scrollbar-thumb-[#222] scrollbar-track-transparent">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-sm border transition-all group relative ${isSelected
                      ? "bg-[#141414] border-[#1F1F1F] border-l-2 border-l-[#D4B483] shadow-lg shadow-black/50"
                      : "bg-[#0A0A0A] border-transparent hover:bg-[#111] border-l-2 border-l-transparent"}`}
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-mono font-medium text-[#666]">#{s.id.substring(0, 6).toUpperCase()}</span>
                      </div>
                      <span className={`text-[9px] font-bold uppercase tracking-wide ${sla.color}`}>{sla.text}</span>
                    </div>

                    <h3 className={`text-sm font-semibold mb-1 truncate pr-4 ${isSelected ? "text-[#E5E5E0]" : "text-[#999] group-hover:text-[#E5E5E0]"}`}>
                      {s.name}
                    </h3>
                    <p className="text-[9px] text-[#555] uppercase tracking-wide mb-3">{context}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-[#0F0F0F] rounded-sm border border-[#1F1F1F] p-6">
                  ...
                  >
                    ...
                    <option value="profile">Simulate: Profile Edit</option>
                    <option value="geo">Simulate: Geo-Hop</option>
                  </select>
                  {simulationAction && (
