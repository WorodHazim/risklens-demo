        ...
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden md:flex items-center space-x-1">
              <button className="px-4 py-2 text-[11px] uppercase tracking-wider font-bold text-[#E5E5E0] border-b-2 border-[#D4B483]">
                Dashboard
              </button>
              <button className="px-4 py-2 text-[11px] uppercase tracking-wider font-bold text-[#666] hover:text-[#CCC] transition-colors border-b-2 border-transparent hover:border-[#333]">
                Policies
              </button>
              <button className="px-4 py-2 text-[11px] uppercase tracking-wider font-bold text-[#666] hover:text-[#CCC] transition-colors border-b-2 border-transparent hover:border-[#333]">
                Audit Log
          ...
          <div className="flex items-center gap-8">
            <button onClick={handleExportQueue} className="text-[10px] font-bold uppercase tracking-wider text-[#555] hover:text-[#D4B483] transition-colors flex items-center gap-2 group">
