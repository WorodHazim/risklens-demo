                ...
                {auditLog.length > 0 ? (
                  <table className="w-full text-left text-xs">
                    <thead className="bg-[#080808] text-[#444] font-semibold border-b border-[#1A1A1A]">
                      <tr>
                        <th className="px-6 py-4 font-bold text-[8px] uppercase tracking-wider text-[#333]">RECORD ID</th>
                        <th className="px-4 py-4 font-bold text-[8px] uppercase tracking-wider text-[#333]">TIMESTAMP (UTC)</th>
                        <th className="px-4 py-4 font-bold text-[8px] uppercase tracking-wider text-[#333]">ACTOR</th>
