        ...
        <div className="max-w-[1500px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-10">
            <button
              ...
              className="text-[9px] font-bold uppercase tracking-widest text-[#666] hover:text-[#D4B483] transition-colors flex items-center gap-2.5 group bg-[#0F0F0F] hover:bg-[#141414] px-3 py-1.5 rounded-sm border border-[#222]"
              title={`Export ${currentView === 'audit' ? 'Audit Log' : 'Case Queue'}`}
            >
              <svg className="w-3 h-3 opacity-60 group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
              Export Data
            </button>
      ...
      <div className="max-w-[1500px] mx-auto p-6 mt-4">
        ...
        {currentView === "policies" && (
          <div className="h-[600px] flex flex-col items-center justify-center bg-[#0A0A0A] rounded-sm border border-[#1F1F1F] animate-in fade-in duration-300">
            ...
            <h2 className="text-lg font-bold text-[#444] uppercase tracking-[0.2em] mb-3">Policy Engine</h2>
            <p className="text-[10px] text-[#333] uppercase tracking-wider max-w-md text-center">
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left p-4 rounded-sm border transition-all duration-200 group relative ${isSelected
                          ...
                          : "bg-[#0A0A0A] border-[#1A1A1A] hover:bg-[#0E0E0E] hover:border-[#262626] border-l-[3px] border-l-transparent opacity-70 hover:opacity-100"}`}
                      >
            ...
            <div className="lg:col-span-8 space-y-8">
              {!result ? (
                <div className="h-full min-h-[600px] flex flex-col items-center justify-center bg-[#0A0A0A] rounded-sm border border-[#1F1F1F] border-dashed text-[#333]">
                  <div className="w-20 h-20 mb-6 opacity-5 relative grayscale">
                    <Image src="/risklens-logo.svg" alt="Logo" fill className="object-contain" />
                  </div>
                  <div className="text-center max-w-xs">
                    <p className="text-sm font-bold text-[#666] mb-1.5 uppercase tracking-[0.2em] opacity-50">Engine Idle</p>
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-700">
                  ...
                  <div className="bg-[#0F0F0F] rounded-sm border border-[#1F1F1F] p-10">
                    <h3 className="text-sm font-bold text-[#E5E5E0] mb-8 flex items-center gap-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                      <div>
                        ...
                        <textarea
                          className="w-full border border-[#333] rounded-sm bg-[#050505] text-sm text-[#CCC] p-5 focus:border-[#D4B483] focus:ring-0 focus:outline-none min-h-[140px] placeholder-[#333] font-mono leading-relaxed"
                        ...
                        <div>
                          ...
                          <div className="flex gap-5 mb-8">
                            <button
                              ...
                              className={`flex-1 px-4 py-5 rounded-sm text-xs font-bold uppercase tracking-[0.1em] transition-all border ${decision === "Accepted"
                            ...
                            <button
                              ...
                              className={`flex-1 px-4 py-5 rounded-sm text-xs font-bold uppercase tracking-[0.1em] transition-all border ${decision === "Overridden"
