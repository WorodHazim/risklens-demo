              ...
              {!result ? (
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-700">
                  ...
                  <div className="bg-[#0A0A0A] rounded-sm border border-[#1F1F1F] p-0 overflow-hidden relative shadow-lg">
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-300 ease-in-out ${isImpactExpanded ? 'max-h-[500px] opacity-100 mt-6' : 'max-h-0 opacity-0 pointer-events-none'}`}
                      aria-hidden={!isImpactExpanded}
                    >
                      {getActionPanelData && (
                        <div className="bg-[#0A0A0A] border border-[#1A1A1A] rounded-sm p-6 shadow-inner relative overflow-hidden">
                          {/* Simulated Projection Badge */}
                          <div className="absolute top-0 right-0 px-3 py-1 bg-[#D4B483]/5 border-l border-b border-[#D4B483]/20 rounded-bl-sm">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                            ...
                            <div className="bg-[#0C0C0C] border border-[#1F1F1F] p-5 rounded-sm group hover:border-[#D4B483]/30 transition-colors">
                              ...
                              <div className="h-1 w-full bg-[#161616] rounded-full overflow-hidden mb-3">
                                <div className="h-full bg-emerald-400/40 w-[40%] transition-all duration-1000 delay-300" style={{ width: isImpactExpanded ? '40%' : '0%' }}></div>
                              </div>
                            ...
                            <div className="bg-[#0C0C0C] border border-[#1F1F1F] p-5 rounded-sm group hover:border-[#D4B483]/30 transition-colors">
                              ...
                              <div className="h-1 w-full bg-[#161616] rounded-full overflow-hidden mb-3">
                                <div className="h-full bg-[#D4B483]/40 w-[65%] transition-all duration-1000 delay-500" style={{ width: isImpactExpanded ? '65%' : '0%' }}></div>
                              </div>
                            ...
                            <div className="bg-[#0C0C0C] border border-[#1F1F1F] p-5 rounded-sm group hover:border-[#D4B483]/30 transition-colors">
                              ...
                              <div className="h-1 w-full bg-[#161616] rounded-full overflow-hidden mb-3">
                                <div className="h-full bg-cyan-400/40 w-[80%] transition-all duration-1000 delay-700" style={{ width: isImpactExpanded ? '80%' : '0%' }}></div>
                              </div>
                              <p className="text-[9px] text-[#777] leading-relaxed">Improved signal precision reduces high-risk escalation.</p>
                            </div>
                          </div>

                          <div className="mt-6 pt-4 border-t border-[#151515] flex justify-between items-center">
                            <p className="text-[9px] text-[#444] font-mono tracking-tighter">// MODEL: PROJECTION_ENGINE_V4.2</p>
