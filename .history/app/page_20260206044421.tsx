                ...
                <div className="overflow-y-auto flex-1 p-4 space-y-2.5 scrollbar-thin scrollbar-thumb-[#222] scrollbar-track-transparent bg-[#050505]">
                  {filteredScenarios.length > 0 ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-center p-8 opacity-50">
                      <p className="text-[10px] font-bold text-[#666] uppercase tracking-[0.2em] mb-2">No Matching Cases</p>
                      <p className="text-[9px] text-[#444] uppercase tracking-wide">Modify filter criteria to expand results</p>
                    </div>
                  )}
                </div>
              </div>
