            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-[#0A0A0A] rounded-sm border border-[#1F1F1F] p-0 h-[220px] flex flex-col overflow-hidden shadow-sm">
                <div className="px-6 py-4 border-b border-[#1A1A1A] bg-[#0F0F0F]/50 flex justify-between items-center">
                  ...
                  <span className="text-[9px] font-mono text-[#444] border border-[#222] px-1.5 rounded-sm">v4.2</span>
                </div>
                ...
                <div className="overflow-y-auto flex-1">
                  {auditLog.length > 0 ? (
                    <table className="w-full text-left text-xs">
                      <thead className="bg-[#0A0A0A] text-[#444] font-semibold border-b border-[#141414] sticky top-0">
                        <tr>
                          ...
                          <th className="px-2 py-2 font-bold text-[9px] uppercase tracking-wider text-[#333]">ACTOR</th>
                          <th className="px-2 py-2 font-bold text-[9px] uppercase tracking-wider text-[#333] text-right pr-5">ACTION TYPE</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-[#141414]">
                        {auditLog.map((log) => (
                          <tr key={log.id} className="hover:bg-[#0E0E0E] transition-colors">
                            ...
                            <td className="px-2 py-2.5 text-[10px] text-[#666] font-medium tracking-wide">Human Analyst</td>
                            <td className="px-2 py-2.5 text-right pr-5">
                              <span className={`inline-flex items-center px-1.5 py-0.5 rounded-sm text-[9px] font-bold uppercase tracking-tight ${log.outcome === "Accepted" ? "text-emerald-500/80 bg-emerald-950/20 border border-emerald-900/30" : "text-amber-500/80 bg-amber-950/20 border border-amber-900/30"}`}>
                                {log.outcome === "Accepted" ? "AI ACCEPTED" : "MANUAL OVERRIDE"}
                              </span>
                            </td>
                          </tr>
                        ))}
                    ...
                    <div className="h-full flex flex-col items-center justify-center p-4 text-center opacity-30">
                      <span className="text-[10px] text-[#555] uppercase tracking-widest font-bold">AWAITING ANALYST ACTIONS</span>
                    </div>
                  )}
                </div>
                <div className="px-4 py-2 bg-[#0C0C0C] border-t border-[#1A1A1A] text-center">
                  <p className="text-[8px] text-[#444] uppercase tracking-widest leading-tight">
                    All analyst actions are logged and retained for regulatory review.
                  </p>
                </div>
              </div>
