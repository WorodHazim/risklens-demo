...
export default function ImpactProjection({ result, actionExecutionState }: ImpactProjectionProps) {
    ...
    return (
        <div className="bg-[#0A0A0A] rounded-sm border border-[#1F1F1F] overflow-visible relative group" id="impact-section">
            ...
            {/* Accordion Content */}
            {isExpanded && (
                <div className="px-10 pb-10 animate-in slide-in-from-top-2 duration-500">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-10">
                        {/* KPI 1 */}
                        <div className="bg-[#050505] border border-[#151515] p-6 rounded-sm hover:border-[#D4B483]/20 transition-all group/kpi">
                            <span className="text-[9px] font-bold text-[#555] uppercase tracking-[0.2em] block mb-3 group-hover/kpi:text-[#777]">Capital Exposure</span>
                            <div className="flex items-baseline gap-2 mb-3">
                                <span className="text-3xl font-thin text-red-500/80">$42,500</span>
                                <span className="text-[9px] text-red-900/60 font-mono font-bold tracking-tighter">EST. LOSS</span>
                            </div>
                            <p className="text-[10px] text-[#666] leading-relaxed font-light">Projected capital at risk if transaction velocity remains unthrottled in the relative window.</p>
                        </div>

                        {/* KPI 2 */}
                        <div className="bg-[#050505] border border-[#151515] p-6 rounded-sm hover:border-[#D4B483]/20 transition-all group/kpi">
                            <span className="text-[9px] font-bold text-[#555] uppercase tracking-[0.2em] block mb-3 group-hover/kpi:text-[#777]">Operational Lift</span>
                            <div className="flex items-baseline gap-2 mb-3">
                                <span className="text-3xl font-thin text-[#D4B483]">+18 min</span>
                                <span className="text-[9px] text-[#D4B483]/50 font-mono font-bold tracking-tighter">SLA DELTA</span>
                            </div>
                            <p className="text-[10px] text-[#666] leading-relaxed font-light">SLA compression achieved through AI-assisted pre-adjudication cycles.</p>
                        </div>

                        {/* KPI 3 */}
                        <div className="bg-[#050505] border border-[#151515] p-6 rounded-sm hover:border-[#D4B483]/20 transition-all group/kpi">
                            <span className="text-[9px] font-bold text-[#555] uppercase tracking-[0.2em] block mb-3 group-hover/kpi:text-[#777]">Detection Variance</span>
                            <div className="flex items-baseline gap-2 mb-3">
                                <span className="text-3xl font-thin text-emerald-500/80">-12.4%</span>
                                <span className="text-[9px] text-emerald-900/60 font-mono font-bold tracking-tighter">FP RATE</span>
                            </div>
                            <p className="text-[10px] text-[#666] leading-relaxed font-light">Significant false-positive reduction compared to legacy rule-based engines.</p>
                        </div>
                    </div>
