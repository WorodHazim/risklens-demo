            ...
            {isOpen && (
                <div className="px-10 pb-10 pt-4 animate-in fade-in duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { label: "Loss Avoidance", val: "+$124.5k", hint: "Projected recovery vs baseline" },
                            { label: "Compliance Delta", val: "Alpha (9.8)", hint: "Regulatory overhead variance" },
                            { label: "Signal Recency", val: "24.2ms", hint: "Processing latency under load" }
                        ].map((item, idx) => (
