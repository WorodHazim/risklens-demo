                        ...
                        {auditLog.length > 0 ? (
                            auditLog.map((log) => (
                                <tr key={log.id} className="hover:bg-[#0C0C0C] transition-colors group">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-sm border ${String(log.outcome) === 'Overridden' ? 'bg-amber-950/20 text-amber-500 border-amber-900/30' : 'bg-emerald-950/20 text-emerald-500 border-emerald-900/30'
                                            }`}>
                                            {String(log.outcome)}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4">
                                        <p className="text-[10px] text-[#666] line-clamp-1 max-w-[200px]" title={String(log.notes)}>
                                            {String(log.notes)}
                                        </p>
                                    </td>
                                    <td className="px-6 py-4">
